export const USERS_MESSAGES = {
    ...
    USERNAME_LENGTH: 'Username length must be from 4 to 15',
    USERNAME_INVALID:
    ...
    UNFOLLOWED_BEFORE: 'Unfollowed before',
    UNFOLLOW_SUCCESS: 'Unfollow success',
    USERNAME_EXISTED_BEFORE: 'Username existed before',
...
export const TWEETS_MESSAGES = {
    ...
    GET_QUOTETWEETS_SUCCESSFULLY: 'Get quote tweets successfully',
